...
complete -c nvme-connect-all -s d -l device -d 'This field takes a device as input'
...
complete -c nvme-connect-all -l keyring -d 'Keyring for TLS key lookup'
complete -c nvme-connect-all -l tls_key -d 'TLS key for the connection (TCP)'
...
complete -c nvme-connect-all -l tls -d 'Enable TLS encryption (TCP)'
